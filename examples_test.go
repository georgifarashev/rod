...
import (
	...
	"github.com/georgifarashev/rod/lib/cdp"
	"github.com/georgifarashev/rod/lib/input"
...
// Doc for environment variables: https://pkg.go.dev/github.com/georgifarashev/rod/lib/defaults
...
// List of cdp API: https://github.com/georgifarashev/rod/tree/main/lib/proto
...
func Example_load_extension() {
	...
	u := launcher.New().
		...
		// You can use XVFB to get rid of it: https://github.com/georgifarashev/rod/blob/main/lib/examples/launch-managed/main.go
		Headless(false).
		MustLaunch()
